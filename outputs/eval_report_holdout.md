...
- Top-1 hit rate: 0.54
- Top-3 hit rate: 0.68
- Low confidence cases: 14

| Test ID | Top-1 | Top-3 | Low confidence | Targets | Detected top 3 |
| --- | --- | --- | --- | --- | --- |
| holdout_001 | False | False | True | cashmere, warm_cotton, wool_blanket | sea_breeze, winter_dawn |
...
| holdout_010 | False | False | True | cold_metal, silver_spoon, crystal |  |
...
| holdout_014 | True | True | False | marble, cold_metal, crystal | crystal, winter_dawn, mountain_stream |
| holdout_015 | False | False | False | wet_moss, forest_floor, after_rain_garden | cold_fog, cashmere, fresh_linen |
...
| holdout_023 | False | False | True | mountain_stream, wet_stone, crystal |  |
...
| holdout_029 | True | True | False | roasted_almond, butter_toast, burnt_sugar | butter_toast, roasted_almond, honeycomb |
...
| holdout_043 | True | True | False | film_grain, old_library, late_night_air | film_grain, four_k_clarity, warm_cotton |
| holdout_044 | True | True | False | four_k_clarity, cut_diamond, crystal | four_k_clarity, mountain_stream, crystal |
...
| holdout_050 | False | False | False | film_grain, late_night_air, old_library | four_k_clarity, cut_diamond, crystal |
...
| --- | --- | --- | --- | --- | --- |
| holdout_001 | 겨울 코트 안쪽에 남은 온기가 조용히 둥글게 퍼지는 향 | cashmere, warm_cotton, wool_blanket | sea_breeze, winter_dawn | low_confidence | Top-1 score is below the low-confidence threshold. |
...
| holdout_010 | 손끝에 닿은 창틀의 냉기처럼 단단하고 맑은 긴장감 | cold_metal, silver_spoon, crystal |  | low_confidence | Top-1 score is below the low-confidence threshold. |
...
| holdout_015 | 젖은 흙 위에 낮게 깔린 초록색 습도가 천천히 올라와 | wet_moss, forest_floor, after_rain_garden | cold_fog, cashmere, fresh_linen | atmosphere_overmatch | Atmospheric object dominated a material/object target. |
...
| holdout_023 | 바위틈 물줄기가 지나간 자리처럼 차고 맑은 흐름만 남아 | mountain_stream, wet_stone, crystal |  | low_confidence | Top-1 score is below the low-confidence threshold. |
...
| holdout_050 | 기억 속 풍경처럼 해상도는 낮지만 온도와 분위기만 부드럽게 남아 | film_grain, late_night_air, old_library | four_k_clarity, cut_diamond, crystal | time_season_underweighted | Time or season cue did not survive into top 3. |
...
Low confidence case count: 14

| Test ID | Input | Top-1 | Score | Notes |
| --- | --- | --- | --- | --- |
| holdout_001 | 겨울 코트 안쪽에 남은 온기가 조용히 둥글게 퍼지는 향 | sea_breeze | 0.14 | Top-1 score is below the low-confidence threshold. |
...
| holdout_010 | 손끝에 닿은 창틀의 냉기처럼 단단하고 맑은 긴장감 |  | 0.00 | Top-1 score is below the low-confidence threshold. |
...
| holdout_023 | 바위틈 물줄기가 지나간 자리처럼 차고 맑은 흐름만 남아 |  | 0.00 | Top-1 score is below the low-confidence threshold. |
