...
### `data/workflow/sensory_object_candidates.jsonl`
...
### `data/vocabulary/domain_mapping.json`
...
- 일부 candidate를 `data/core/sensory_objects.jsonl`에 병합한다.
- 병합된 candidate에 대해 `data/core/phrase_cues.json`을 추가한다.
